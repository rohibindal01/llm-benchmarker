...
2. Create a feature branch (`git checkout -b feature/add-model-xyz`)
...
Scores represent best-effort interpretations of publicly available benchmarks as of April 2025. Model performance varies by task, prompt, and version. Always evaluate models on your specific use case before making production decisions.
